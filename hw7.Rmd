...
```
可得訓練組案例數為`r sum(BreastCancerC$Test==F)`測試組案例數為`r sum(BreastCancerC$Test==T)`
...
- 敏感度 `r sensitivity(MinePred,BreastCancerC[BreastCancerC$Test==T,]$Class)*100`%
- 特異性 `r specificity(MinePred,BreastCancerC[BreastCancerC$Test==T,]$Class)*100`%
- 陽性預測率 `r posPredValue(MinePred,BreastCancerC[BreastCancerC$Test==T,]$Class)*100`%
- 陰性預測率 `r negPredValue(MinePred,BreastCancerC[BreastCancerC$Test==T,]$Class)*100`%